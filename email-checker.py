...
while True:
    ...
    rz = requests.get(
        f'https://emailsverified-django.herokuapp.com/api/yahoo/?username={reads.replace("@yahoo.com", "")}').text
    rg = requests.get(
        f'https://emailsverified-django.herokuapp.com/api/gmail/?username={reads.replace("@gmail.com", "")}').text
    if "taken" in rz:
        print(f"{reads}: Taken[!]")
